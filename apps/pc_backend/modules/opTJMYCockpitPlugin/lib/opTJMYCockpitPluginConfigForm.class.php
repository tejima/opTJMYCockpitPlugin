<?php
class opTJMYCockpitPluginConfigForm extends sfForm
{
  protected $configs = array(

//s($app['all']['twipne_config']['accesskey'],$app['all']['twipne_config']['secretaccesskey']);
    'gapps_id' => 'optjmycockpitplugin_gapps_id',
    'gapps_password' => 'optjmycockpitplugin_gapps_password',
    'gapps_sheetkey' => 'optjmycockpitplugin_gapps_sheetkey',
    'gapps_sheetid' => 'optjmycockpitplugin_gapps_sheetid',
  );
  public function configure()
  {
    ...
    $this->getWidgetSchema()->setNameFormat('tjmycockpit[%s]');
  }
